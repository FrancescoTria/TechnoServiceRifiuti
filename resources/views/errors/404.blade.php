...
<body>
    <div class="container-404">
        ...
        <div class="error-title">404 - Pagina non trovata</div>
        <div class="error-msg">La pagina che cerchi non esiste o è stata rimossa.<br>Controlla l'indirizzo o torna alla
            home.</div>
